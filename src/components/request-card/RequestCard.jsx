        ...
        <div className="details">
          ...
          {param.type === "bechlor" ? (
            <div className="req-details">
              ...
              <a href={`${request.CV}`} target="_blank">
                cv
              </a>
              <a href={`${request.HighSchoolCertificate}`} target="_blank">
                High School Certificate
              </a>
              <a href={`${request.Passport}`} target="_blank">
                Passport
              </a>
              <a href={`${request.PersonalPicture}`} target="_blank">
                Personal Picture
              </a>
              <a href={`${request.PersonalStatement}`} target="_blank">
                Personal Statement
              </a>
            </div>
          ) : null}
